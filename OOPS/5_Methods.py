...
3. Static method: It does not take self or cls as the first parameter and is defined using the @staticmethod decorator. It cannot access or modify class variables. It can be called using the class name or instance name.
it is independent of the class and can be called without creating an instance of the class. It is used to perform a specific task that is related to the class but does not require access to the class or instance variables."""
...
print(obj.var_1) #15 #This will print the instance variable var_1 for obj
obj2 = type_methods()
print(obj2.var_1) #10
print("Using class method ...")
type_methods._change_value(20) #Value of var_1 is changed to 20
print(obj2.var_1) #20 (class variable var_1 is changed for all the instances of the class)
print(obj.var_1) #15 (instance variable var_1 is not changed)
obj3 = type_methods()
print(obj3.var_1) #20 (class variable var_1 is changed for all the instances of the class)
